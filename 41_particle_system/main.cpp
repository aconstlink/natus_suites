...
// @obsolete
// this test just starts the particle system with a prototype
// so this test is obsolete. See the second particle system test
// for how to use the engines internal particle system
//
// OBSOLETET
//
namespace nps
