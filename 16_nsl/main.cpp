...
void_t test_5( natus::io::database_res_t db )
{
    natus::nsl::database_res_t ndb = natus::nsl::database_t() ;
    natus::ntd::vector< natus::io::location_t > shader_locations = {
        natus::io::location_t( "shaders.main_early_return.nsl" )
    };
...
void_t test_6( natus::io::database_res_t db )
{
    natus::nsl::database_res_t ndb = natus::nsl::database_t() ;
    natus::ntd::vector< natus::io::location_t > shader_locations = {
        natus::io::location_t( "shaders.inout.nsl" )
    };
